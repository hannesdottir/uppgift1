        ...
        <div className='flex flex-row flex1'>
            <div className='w-1/2'>
                ...
                <p className='mx-6 mt-10 w-3/4'>
                    ...
                    låta dina användare lära känna dig. Här kan du skriva en längre text om ditt
